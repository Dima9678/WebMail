...
namespace Persistence.Migrations
{
    ...
    [Migration("20260726132104_ParentAndChildLetters")]
    partial class ParentAndChildLetters
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.Letter", b =>
                {
                    ...
                    b.HasOne("Domain.Models.Letter", "ParentLetter")
                        .WithOne("ChidLetter")
                        .HasForeignKey("Domain.Models.Letter", "ParentLetterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
